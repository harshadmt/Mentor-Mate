            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { action: "Content reported", user: "Mike Chen", time: "15 min ago", type: "report" },
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {[
                  { message: "New users waiting approval", severity: "warning", time: "10 min ago" },
...
const QuickActionButton = ({ icon, label, gradient, onClick }) => (
  <button 
    onClick={onClick}
    className={`w-full flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r ${gradient} text-white hover:shadow-md hover:scale-105 transition-all duration-200 group`}
  >
